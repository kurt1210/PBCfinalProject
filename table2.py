...
the_table1 = plt.table(
    cellText=[['全穀雜糧類 1 碗 ( 碗為一般家用飯碗、重量為可食重量 )', '豆魚蛋肉類 1 份 ( 重量為可食部分生重 )', '乳品類 1 杯 ( 1 杯 = 240 毫升全脂、脫脂或低脂奶 = 1 份 )']],
    loc='center',
    cellLoc='center',
    bbox=[0, 0.75, 1, 0.1]
    )
...
df['油脂與堅果種子類 1 份 ( 重量為可食重量 )'] = [
    '= 芥花油、沙拉油等各種烹調用油 1 茶匙 (5 公克)\n= 杏仁果、核桃仁 (7 公克) 或 開心果、南瓜子、葵花子、\n   黑 (白) 芝麻、腰果 (10 公克) 或 各式花生仁 (13 公克)\n   或 瓜子 ('
    '15 公克 )\n= 沙拉醬 2 茶匙 (10 公克) 或 蛋黃醬 1 茶匙 (8 公克)']

the_table3 = plt.table(
    cellText=[['蔬菜類 1 份 ( 1 份為可食部分生重約 100 公克 )', '水果類 1 份 ( 1 份為切塊水果約大半碗 ~1 碗 ) ', '油脂與堅果種子類 1 份 ( 重量為可食重量 )']],
    loc='center',
    cellLoc='center',
    bbox=[0, 0.3, 1, 0.1]
    )
